...
function AdminDashboard({ username, handleLogout }) {
  ...
  const facultyDepartments = {
    "Faculty of Applied Science": ["Department of Physical", "Department of Biological"],
    "Faculty of Business Studies": ["Department of Management", "Department of Finance"],
    "Faculty of Technological Studies": ["Department of Engineering", "Department of IT"],
  };
  ...
  const handleLevelSelectStudents = (level) => {
          ...
          <div className="dropdown-section">
            ...
            {selectedDepartment && (
              <div className="dropdown" style={{ marginTop: "20px" }}>
                ...
                <select
                  value={selectedLevel}
                  onChange={(e) => handleLevelSelectStudents(e.target.value)}
                >
